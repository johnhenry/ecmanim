...
//   ecmanim render examples/hello-scene.js -q low -o examples/out/hello.mp4
import { Scene, Circle, Text, Create, Write, GrowFromCenter, BLUE, YELLOW } from "../src/index.ts";

export default class HelloScene extends Scene {
  async construct() {
    const t = new Text("Hello, ecmanim", { fontSize: 0.8, color: YELLOW });
