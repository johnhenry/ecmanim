...
md`# Force-directed graph component

This network of character co-occurence in _Les Misérables_ is positioned using [D3’s force layout](https://github.com/d3/d3-force). Color represents arbitrary clusters in the data. Drag nodes below to better understand connections. See also a [disconnected graph](/@d3/disjoint-force-directed-graph/2), a [canvas version](/@d3/force-directed-graph-canvas/2), and compare to [WebCoLa](/@mbostock/hello-cola). Data: [Stanford Graph Base](https://www-cs-faculty.stanford.edu/~knuth/sgb.html)`
)}
...
howto("ForceGraph", {alternatives: `[Force-directed graph example](/@d3/force-directed-graph/2)`})
)}
...
export default function define(runtime, observer) {
  ...
  main.define("module 1", async () => runtime.module((await import("/@d3/example-components.js?v=4&resolutions=a6c00de7c09bdfa1@340")).default));
  main.define("module 2", async () => runtime.module((await import("/@d3/color-legend.js?v=4&resolutions=a6c00de7c09bdfa1@340")).default));
