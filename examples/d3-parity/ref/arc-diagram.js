...
md`<div style="color: grey; font: 13px/25.5px var(--sans-serif); text-transform: uppercase;"><h1 style="display: none;">Arc diagram</h1><a href="https://d3js.org/">D3</a> › <a href="/@d3/gallery">Gallery</a></div>
...
function _2(Inputs,orders,chart,Event)
{
...
function _chart(nodes,d3,orders,links)
{
...
function _nodes(miserables){return(
miserables.nodes
)}

function _links(miserables){return(
miserables.links
)}

function _orders(d3,links,nodes)
{
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["Inputs","orders","chart","Event"], _2);
  main.variable(observer("chart")).define("chart", ["nodes","d3","orders","links"], _chart);
  main.variable(observer()).define(["md"], _4);
  main.variable(observer("miserables")).define("miserables", ["FileAttachment"], _miserables);
  main.variable(observer("nodes")).define("nodes", ["miserables"], _nodes);
  main.variable(observer("links")).define("links", ["miserables"], _links);
  main.variable(observer("orders")).define("orders", ["d3","links","nodes"], _orders);
  return main;
}
