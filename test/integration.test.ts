...
import { ValueTracker, DecimalNumber } from "../src/mobject/value_tracker.ts";
import { AnimationGroup, LaggedStart } from "../src/animation/composition.ts";
import { FadeIn, Create } from "../src/animation/Animation.ts";
import { GrowFromCenter, Indicate } from "../src/animation/extra.ts";
