...
rigid-body physics ([physics.md](physics.md)), **ThorVG-WASM** for
full-fidelity Lottie import ([interchange.md](interchange.md)), **ELK/dagre**
for large-graph diagram layout
([animation-presentation.md](animation-presentation.md)), and **Piper** (or any
